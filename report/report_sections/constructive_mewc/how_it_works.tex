...
\subsection{How it works}
    ...
    \begin{minipage}{\linewidth}
        ...
        \begin{minipage}{0.6\textwidth}
            At the initial step, as said before, we will initialize $S$, $P$ and $Z$ by sorting the vertices based on a criteria. Here we chose the vertex of highest degree.
            \begin{center}
                \begin{tabular}{|lll|}
                    \hline
