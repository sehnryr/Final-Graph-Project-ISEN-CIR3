...
such as social networks, chemistry, bioinformatics. Now, we will give a concrete
example of a real-life situation that can be modelled as a MEWC problem. \bigskip

\textbf{The team formation process} for a project, or for the search for a particular
social group, is a situation that can be viewed as a MEWC problem. 
\newpage
Let's imagine that
...
has the highest affinity. \bigskip
...
\begin{figure}[H]
    ...
    \label{fig:applications_example}
\end{figure}
